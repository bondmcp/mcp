...
class SDKGenerator {
   ...
   */
  checkDependencies() {
    const requiredTools = ["openapi-generator-cli", "npm", "python3"];
  ...
  installTools() {
    ...
    try {
      ...
      execSync("pip install openapi-python-client hatch twine", {
        stdio: "inherit",
      });
  ...
  switch (command) {
    ...
    case "typescript":
      ...
      if (!tsSpecPath || !tsVersion) {
        console.error(
          "Usage: node sdk-generator.js typescript <spec-path> <version>",
        );
        process.exit(1);
      }
    ...
    case "python":
      ...
      if (!pySpecPath || !pyVersion) {
        console.error(
          "Usage: node sdk-generator.js python <spec-path> <version>",
        );
        process.exit(1);
      }
